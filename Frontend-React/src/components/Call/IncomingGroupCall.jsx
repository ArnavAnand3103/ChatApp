...
export default function IncomingGroupCall({ onAccept, onReject }) {
    ...
    const { incomingGroupCall } = useCall();
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    Incoming Group {incomingGroupCall.callType === "video" ? "Video" : "Audio"} Call
                </h2>
                ...
                >
                    {incomingGroupCall.callerName || incomingGroupCall.callerEmail} is calling...
                </p>
